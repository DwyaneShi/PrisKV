 ...
 * 1. A Read-Only mapping (PROT_READ) for 'acquire' operations.
 * 2. A Read-Write mapping (PROT_READ | PROT_WRITE) for 'alloc' operations.
 * This will ensure that any unauthorized write to 'acquire' regions results in a Segmentation
 * Fault.
 */
