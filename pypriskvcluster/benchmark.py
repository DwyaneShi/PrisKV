...
class PriskvClusterBenchmark:
    ...
    def __init__(self, args):
        ...
        self.client = priskvcluster.PriskvClusterClient(args.raddr, args.rport, args.password)
    ...
    def run(self):
        ...
        while True:
            ret = self.exec_op()
            if ret != 0:
                print("priskvcluster benchmark failed: %d", ret)
                return
...
class PriskvClusterBenchmarkNumpy(PriskvClusterBenchmark):
    ...
    def __init__(self, args):
        ...
        self.shared_val_sgl = priskvcluster.SGL(self.reg_buf.ctypes.data,
...
def main():
    parser = argparse.ArgumentParser(description='Priskv Cluster Benchmark')
    ...
    benchmark = PriskvClusterBenchmarkNumpy(args)
