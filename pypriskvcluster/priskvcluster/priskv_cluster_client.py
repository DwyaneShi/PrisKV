...
import priskvcluster._priskvcluster as client
from typing import List, Tuple, Optional


class PriskvClusterClient:
    '''PriskvClusterClient:
    ...
    def set(self,
            ...
            sgl: client.SGL,
            nsgl: int = 1,
            timeout: int = client.PRIS_KEY_MAX_TIMEOUT) -> int:
    ...
    def mset(
            ...
            timeout: int = client.PRIS_KEY_MAX_TIMEOUT
    ) -> Tuple[int, List[int]]:
