...
ext_modules = [
    Pybind11Extension(
        "priskvcluster._priskvcluster._priskv_cluster_client",
        ["pybind.cpp"],
...
setup(
    ...
    version='0.0.2',
    description=
    '''This is priskvcluster's client. priskvcluster is specifically designed for modern high-performance '''
    '''computing (HPC) and artificial intelligence (AI) computing. It solely supports RDMA. '''
    '''priskvcluster also supports GDR (GPU Direct RDMA), enabling the value of a key to be directly '''
    '''transferred between priskvcluster and the GPU.''',
    # package_data={
    #     'priskvcluster._priskvcluster': ['*.pyi', '*.so'],
    # },
